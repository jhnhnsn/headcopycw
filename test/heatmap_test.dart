...
void main() {
  testWidgets('calendar grid renders 20 weeks without overflow',
    ...
    final days = dailyActivity(sessions, today: today, days: 140, wholeWeeks: true);
  ...
  testWidgets('empty history renders nothing (no crash)',
      (WidgetTester tester) async {
    final days = dailyActivity([], today: DateTime(2026, 7, 21), days: 140);
    await tester.pumpWidget(MaterialApp(
